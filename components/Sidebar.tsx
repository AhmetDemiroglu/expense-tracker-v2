      ...
      <div className={sidebarClasses}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-slate-800 flex items-center gap-3">
            <div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-indigo-500/30">
              FA
            </div>
            <div>
              <h1 className="font-bold text-white tracking-tight">Finans Asistanı</h1>
              {user.isAnonymous && (
                <span className="text-[10px] uppercase tracking-wider text-amber-500 font-semibold">Misafir Modu</span>
              )}
            </div>
          </div>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate">
                  {user.isAnonymous ? 'Misafir Kullanıcı' : user.email}
                </p>
              </div>
            </div>
            <button
