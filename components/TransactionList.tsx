...
export const TransactionList: React.FC<TransactionListProps> = ({ transactions, userId, onDelete, onEdit }) => {
                                                ...
                                                {groupTxs.map((t) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center gap-1 pl-2">
                                                            <span className={`font-bold text-sm md:text-base whitespace-nowrap mr-2 ${t.type === "income" ? "text-emerald-400" : "text-white"}`}>
                                                                {t.type === "income" ? "+" : "-"}{t.amount.toLocaleString("tr-TR", { minimumFractionDigits: 2 })} ₺
                                                            </span>

                                                            <button
                                                                onClick={(e) => { e.stopPropagation(); onEdit(t); }}
                                                                className="w-8 h-8 flex items-center justify-center rounded-lg text-indigo-400 hover:bg-indigo-500/20 transition-all"
                                                                title="Düzenle"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-8 h-8 flex items-center justify-center rounded-lg text-rose-400 hover:bg-rose-500/20 transition-all"
                                                                title="Sil"
                                                            >
